...
const upsertCache = db.prepare(`
  INSERT INTO movies_cache (tmdb_id, title, year, genre, genres, poster, director, runtime, tmdb_score, tmdb_votes, cached_at)
  VALUES (@id, @title, @year, @genre, @genres, @poster, @director, @runtime, @score, @votes, datetime('now'))
