...
/** Accent- and case-insensitive, so "cacador" finds "Caçador". */
  ...
  return (
    <button
      ...
      className={cn(
        ...
        on ? 'bg-dye-cyan/10 text-dye-cyan ring-dye-cyan/60' : 'text-ink-dim ring-house-rail hover:text-ink hover:ring-white/20'
      )}
    >
      {children}
    </button>
